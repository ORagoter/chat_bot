...
train_data_lengths = [len(sequence) for sequence in train_questions_seq + train_answers_seq]
sns.histplot(train_data_lengths, bins=20, color='blue', kde=True, label='Train Data')
plt.xlabel('Length of sequences')
plt.ylabel('Frequency')
plt.title('Histogram of sequence lengths in train data')
plt.legend()
plt.show()


test_data_lengths = [len(sequence) for sequence in test_questions_seq + test_answers_seq]
sns.histplot(test_data_lengths, bins=20, color='blue', kde=True, label='Test Data')
plt.xlabel('Length of sequences')
plt.ylabel('Frequency')
plt.title('Histogram of sequence lengths in train data')
plt.legend()
